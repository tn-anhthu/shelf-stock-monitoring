...
- Throwaway scripts (not committed, not part of the repo), all in a local
  scratchpad directory: `inv1_test3_old_rows.py`, `inv1_context.py`,
  `inv1_full_rows_1950_2750.py`, `inv2_haohao.py`, `inv2_contained.py`.
