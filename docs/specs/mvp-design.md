...
- Nhận diện ranh giới giữa nhiều đơn vị kệ/tủ khác nhau trong cùng 1 ảnh (ví dụ 2 tủ lạnh đặt sát nhau, ảnh vô tình lấy lẫn sản phẩm của tủ bên cạnh) — phát hiện 2026-07-21 khi stress-test gap detection trên ảnh tủ lạnh nước ngọt (xem docs/reports/week-01/2026-07-21.md). Input giả định của toàn hệ thống là "1 ảnh = đúng 1 đơn vị kệ/tủ trọn vẹn" (mục 2, dòng đầu) — ảnh lấn sang đơn vị khác là ngoài giả định này, không phải bug cần vá bằng thêm heuristic. Xử lý bằng kỷ luật chụp ảnh (nhân viên chụp đúng khung 1 tủ).
